...
<html>
  ...
  <head lang="en">
    <meta charset="utf-8">
    <title>童翼优势</title>
    <meta name="keywords" content="童翼优势,童翼优势,童翼优势">
    <meta name="description" content="童翼优势,童翼优势,童翼优势">
  ...
  <body class="body xz ">
    ...
    <section class="kc_section_01">
      <div class="container fix">
        <form  method="post" action="/advantage">
          <div class="div1 fl">
            <div class="divv1">
          ...
          <div class="div2 fl">
            <input type="submit" class="but_01" value="搜索优势"></div>
        </form>
      </div>
    </section>
    <section class="container">
      ...
      @foreach($advantage as $k=>$v)
        <div class="col-md-4 col-sm-6">
          <a href="/advantages/{{$v->id}}.html"  class="db a1 tc">
            <span class="db ovh">
      ...
      <div style="float:right;">{!! $advantage->appends($request->only(['list_length','title']))->render() !!} </div>
