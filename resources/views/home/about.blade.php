...
<html>
  ...
  <head lang="en">
    ...
    <meta name="description" content="{{$about->describe}}">
  ...
  <body class="body xz ">
    ...
    <section class="container" style="font-size: 15px;">
        ...
        <div class="title tc mb35">
          <span class="span1 db">{{$about->title}}</span>
          <span class="span2 db fa">{{$about->describe}}</span>
        </div>
        <div class="mod-02 tc mb35">{!!$about->content!!}</div>
