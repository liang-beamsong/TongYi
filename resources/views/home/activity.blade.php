...
<html>
  ...
  <head lang="en">
    <meta charset="utf-8">
    <title>最新活动</title>
    <meta name="keywords" content="最新活动,童翼活动列表,童翼活动">
    <meta name="description" content="最新活动,童翼活动列表,童翼活动">
    ...
    <section class="kc_section_01">
      <div class="container fix">
        <form  method="post" action="/activity">
          ...
          <div class="div2 fl">
            <input type="submit" class="but_01" value="搜索活动"></div>
        </form>
      </div>
    </section>
    <section class="container">
      ...
      @foreach($activity as $k=>$v)
        <div class="col-md-4 col-sm-6">
          <a href="/activitys/{{$v->id}}.html"  class="db a1 tc">
            <span class="db ovh">
      ...
      <div style="float:right;">{!! $activity->appends($request->only(['list_length','title']))->render() !!} </div>
