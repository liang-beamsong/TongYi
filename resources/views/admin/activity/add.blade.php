    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title" style="margin-left: 20px;">新增活动</h3>
            </div>
            <div class="panel-body">
                <form action="/activity/insert" method="post" enctype="multipart/form-data" class="form-horizontal form-border" id="form" novalidate="novalidate">
                    <div class="form-group">
                        <label class="col-sm-1 control-label">标题</label>
                        <div class="col-sm-10">
                            <input type="text" maxlength="30" class="form-control" name="title" id="input1" required="" placeholder="请输入文章标题!">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label">关键词</label>
                        <div class="col-sm-10">
                            <input type="text" maxlength="50" class="form-control" name="keyword" id="input2" required="" placeholder="请输入文章关键词!">
                        </div>
                    </div>
                    <div class="form-group">
