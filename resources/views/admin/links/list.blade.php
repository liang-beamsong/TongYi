    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">链接列表</h3></div>
        <div class="panel-body">
          <div role="grid" id="example_wrapper" class="dataTables_wrapper form-inline no-footer">
          <form action="/links/list">
            <div class="row">
              <div class="col-xs-6">
            ...
            <table id="example" class="table table-striped table-bordered dataTable no-footer" cellspacing="0" width="100%" aria-describedby="example_info" style="width: 100%;">
              <thead>
                <tr role="row">
                  ...
                  <th  aria-controls="example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 100px;text-align: center;">网站名称</th>
                  <th aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 50px;text-align: center;">网站地址</th>
              ...
              <tbody>
                    @foreach($links as $k=>$v)
                        <tr class="even" style="text-align: center;">
                            ...
                            <td>{{$v->name}}</td>
                            <td>{{$v->url}}</td>
                            <td><a href="/links/edit?id={{$v->id}}">修改</a> | <a href="/links/dele?id={{$v->id}}">删除</a></td>
                        </tr>
                    @endforeach
              </tbody>
            </table>
            <div class="row">
              ...
              <div class="col-xs-6">
                <div class="dataTables_paginate paging_simple_numbers" id="example_paginate">
                   <ul class="pagination">
                      {!! $links->appends($request->only(['list_length','name']))->render() !!} 
                    </ul>
                </div>
              </div>
            </div>
