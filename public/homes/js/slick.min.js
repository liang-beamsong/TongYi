...
function(a) {
	...
	b = function() {
		...
		if ((b.options.fade === !0 || b.options.vertical === !0) && (b.options.centerMode = !1), b.options.infinite === !0 && b.options.fade === !1 && (d = null, b.slideCount > b.options.slidesToShow)) {
			for (e = b.options.centerMode === !0 ? b.options.slidesToShow + 1 : b.options.slidesToShow, c = b.slideCount; c > b.slideCount - e; c -= 1) d = c - 1, a(b.$slides[d]).clone(true).attr("id", "").prependTo(b.$slideTrack).addClass("slick-cloned");
			for (c = 0; e > c; c += 1) d = c, a(b.$slides[d]).clone(true).attr("id", "").appendTo(b.$slideTrack).addClass("slick-cloned");
			b.$slideTrack.find(".slick-cloned").find("[id]").each(function() {
				a(this).attr("id", "")
			})
			// $('.gundong .item').hover(function(){
		 //        if($(window).width()>992){
		 //            $(this).find('span.span1 bdo.bdo1').stop(true,true).css('z-index',1);
		 //            $(this).find('span.span1 bdo.bdo1').stop(true,true).animate({'opacity':1},300);
		 //        }
		 //    },function(){
		 //        $(this).find('span.span1 bdo.bdo1').stop(true,true).animate({'z-index':-1,'opacity':0},300);
		 //    })
		 //    $('.gundong .item').click(function(){
		 //        if($(window).width()<=991){
		 //            $(this).find('span.span1 bdo.bdo1').stop(true,true).css('z-index',1);
		 //            $(this).find('span.span1 bdo.bdo1').stop(true,true).animate({'opacity':1},300);
		 //            $(this).siblings().find('span.span1 bdo.bdo1').stop(true,true).animate({'z-index':-1,'opacity':0},300);
		 //        }
		 //    })
		}
